...
>## 接口链接
    ...
    测试URL地址：https://paychanneldev.pagsmile.com:8443/api/debit
    正式URL地址：https://paychannel.pagsmile.com/api/debit 
...
payment.debit_card.number | String | Yse | 19 | 卡号 | 455187******0183
payment.debit_card.holder | String | Yse | 255 | 持卡人姓名。 | Test User Name
payment.debit_card.expirationDate | String | Yse | 7 | 借记卡逾期时间。 | 12/2030
payment.debit_card.securityCode | String | Yse | 4 | 借记卡背面安全码。 | 123
payment.debit_card.brand | String | No | 10 | 借记卡发卡行。(visa,master,amex,elo,aura,jcb,dinners,discover) | visa
